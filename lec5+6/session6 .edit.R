...
myData<-read.table('C:\\Users\\امنيه\\Downloads\\surgery.txt',header=T)
View(myData)
...
#to test normality 
#females
#convert chr to numeric  # very important 
myData$BMIpre=as.numeric(gsub(",",".",myData$BMIpre))
myData$BMIpost=as.numeric(gsub(",",".",myData$BMIpost))
str(myData)
...
hist(myData[myData$sex == "Female",]$BMIpre)
